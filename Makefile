...
TEST_SOURCES := src/room_engine/renderer/renderer.cpp src/room_engine/renderer/debug_draw.cpp src/room_engine/renderer/renderer_2d.cpp src/room_engine/renderer/renderer_3d.cpp tests/smoke_test.cpp
FORMAT_SOURCES := $(APP_SOURCES) src/room_engine/application.hpp src/room_engine/renderer/renderer.hpp src/room_engine/renderer/camera.hpp src/room_engine/renderer/math.hpp src/room_engine/renderer/debug_draw.hpp src/room_engine/renderer/viewport.hpp src/room_engine/renderer/renderer_2d.hpp src/room_engine/renderer/renderer_2d.cpp src/room_engine/renderer/renderer_3d.hpp src/room_engine/renderer/renderer_3d.cpp tests/smoke_test.cpp
